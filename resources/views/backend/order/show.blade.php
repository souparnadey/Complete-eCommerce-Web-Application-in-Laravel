        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-lx-4">
                <div class="order-info">
                    ...
                    <table class="table">
                        ...
                        <tr><td>Shipping Charge</td><td> : ₹{{$order->shipping->price}}</td></tr>
                        <tr><td>Coupon</td><td> : ₹{{ number_format($order->coupon,2) }}</td></tr>
            ...
            <div class="col-lg-6 col-lx-4">
                <div class="shipping-info">
                    ...
                    <table class="table">
                        <tr><td>Full Name</td><td> : {{$order->first_name}} {{$order->last_name}}</td></tr>
                        <tr><td>Email</td><td> : {{$order->email}}</td></tr>
                        <tr><td>Phone No.</td><td> : {{$order->phone}}</td></tr>
                        <tr><td>Address</td><td> : {{$order->address1}}, {{$order->address2}}</td></tr>
                        <tr><td>Country</td><td> : {{$order->country}}</td></tr>
                        <tr><td>Post Code</td><td> : {{$order->post_code}}</td></tr>
                    </table>
                </div>
            </div>
